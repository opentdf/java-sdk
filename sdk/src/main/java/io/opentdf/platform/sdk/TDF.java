...
public class TDF {
    ...
    public Reader loadTDF(SeekableByteChannel tdf, SDK.KAS kas, KeyAccessServerRegistryServiceClient kasRegistryService, String platformUrl)
            throws DecoderException, IOException, ParseException, NoSuchAlgorithmException, JOSEException, URISyntaxException {
        return loadTDF(tdf, kas, Config.newTDFReaderConfig(), kasRegistryService, platformUrl);
    }

    public Reader loadTDF(SeekableByteChannel tdf, SDK.KAS kas, Config.TDFReaderConfig tdfReaderConfig, KeyAccessServerRegistryServiceClient kasRegistryService, String platformUrl)
            throws DecoderException, IOException, ParseException, NoSuchAlgorithmException, JOSEException, URISyntaxException {
